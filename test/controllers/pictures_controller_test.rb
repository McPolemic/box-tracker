...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference("Picture.count") do
      post pictures_url, params: { picture: { content_type: @picture.content_type, data: @picture.data } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { content_type: @picture.content_type, data: @picture.data } }
