...
class BoxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create box" do
    assert_difference("Box.count") do
      post boxes_url, params: { box: { contents: @box.contents, display_name: @box.display_name } }
    end
  ...
  test "should update box" do
    patch box_url(@box), params: { box: { contents: @box.contents, display_name: @box.display_name } }
